...
secondLabelTabOne_1=Label(tab1, text='Dataset division options',font=('Helvetica 12 bold'))
secondLabelTabOne_1.place(x=250,y=60)
...
secondLabelTabTwo=Label(tab1, text='% data-points in test set2',font=("Helvetica", 12))
secondLabelTabTwo.place(x=130,y=240)
secondEntryTabTwo=Entry(tab1)
secondEntryTabTwo.place(x=310,y=240)

thirdLabelTabTwo=Label(tab1, text='Seed value2',font=("Helvetica", 12))
